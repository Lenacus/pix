...
const recomputeCertificationCoursesV2 = require('../../../scripts/compute-missing-v2-certification-score/compute-missing-certifv2-scores');
...
describe('Compute missing certification v2 scores', () => {
  ...
  it('should update the assessment state to completed', async () => {
    // given
